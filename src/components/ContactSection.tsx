            ...
            >
              ...
              <div className="flex flex-col gap-3">
                ...
                >
                  ...
                  >
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="rgba(196,154,42,0.7)">
                  ...
                  <div>
                    <span
                      className="font-sans"
                      style={{ fontSize: "0.84rem", color: "#F0E8D5", display: "block" }}
                    >
                      WhatsApp
                    </span>
                    <span
                      className="font-sans"
                      style={{ fontSize: "0.75rem", color: "rgba(240,232,213,0.4)" }}
                    >
                      +225 07 67 00 96 29
                    </span>
                  </div>
            ...
            {formState === "success" ? (
              ...
              >
                ...
                <p
                  ...
                  style={{ fontSize: "1.4rem", fontWeight: 400, color: "#F5EFE0", marginBottom: "0.75rem" }}
                >
                  Message reçu.
                </p>
                <p
                  className="font-sans"
                  style={{ fontSize: "0.84rem", color: "rgba(240,232,213,0.5)", lineHeight: 1.65 }}
                >
              ...
              <form onSubmit={handleSubmit} noValidate>
                <div className="flex flex-col gap-5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label htmlFor="name" className="font-display" style={labelStyle}>
                        Nom complet *
                      </label>
                      <input
                        id="name"
                    ...
                    <div>
                      <label htmlFor="email" className="font-display" style={labelStyle}>
                        Email *
                      </label>
                      <input
                        id="email"
                  ...
                  {/* Phone */}
                  <div>
                    <label htmlFor="phone" className="font-display" style={labelStyle}>
                      Téléphone / WhatsApp
                    </label>
                    <input
                      id="phone"
                  ...
                  {/* Service */}
                  <div>
                    <label htmlFor="service" className="font-display" style={labelStyle}>
                      Besoin principal
                    </label>
                    <select
                      id="service"
                      ...
                      onBlur={(e) => (e.target.style.borderColor = "rgba(196,154,42,0.18)")}
                    >
                      <option value="" style={{ background: "#2A1F0E" }}>
                        Sélectionner un service
                      </option>
                      {services.map((s) => (
                        <option key={s} value={s} style={{ background: "#2A1F0E" }}>
                          {s}
                        </option>
                      ))}
                    </select>
                  ...
                  {formState === "error" && (
                    <p
                      className="font-sans"
                      style={{ fontSize: "0.82rem", color: "rgba(220,80,80,0.8)" }}
                    >
                      {errorMsg}
                    </p>
                  )}
                  ...
                  <p
                    ...
                    style={{ fontSize: "0.72rem", color: "rgba(240,232,213,0.28)" }}
                  >
